...
export const JOULE_STORY_FAMILIES: readonly JouleStoryFamilyAuthority[] = [
  ...
  { id: 'isobaric-heat', directionIds: ['heat_input:q_in', 'heat_input:T3', 'heat_input:T2', 'heat_rejection:q_out', 'heat_rejection:T1', 'heat_rejection:T4'], entryPointLatex: 'q_{in} = h_3-h_2', conditions: ['isobaric component', 'constant c_p'], sectionId: 'heat-input-2-3', transitions: ['integrate', 'substitute', 'divide', 'multiply'] },
